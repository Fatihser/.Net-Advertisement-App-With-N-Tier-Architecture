...
namespace FSE.AdvertisementApp.Business.Services
{
        ...
        where T:BaseEntity
    {
        ...
        public async Task<IResponse> RemoveAsync(int id)
        {
            ...
            if (data == null)
            {
                return new Response(ResponseType.NotFound, $"{id} idsine sahip data bulunamadi");
        ...
        public async Task<IResponse<UpdateDto>> UpdateAsync(UpdateDto dto)
        {
            ...
            if (result.IsValid)
            {
                ...
                {
                    return new Response<UpdateDto>(ResponseType.NotFound, $"{dto.Id} idsine sahip data bulunamadi");
                }
